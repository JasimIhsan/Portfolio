...
export const experiences: ExperienceItem[] = [
   {
      id: "ciltriq-technologies",
      company: "Ciltriq Technologies",
      role: "Software Development Engineer",
      duration: "2025 – 2026",
      type: "Full-Time",
      status: "active",
      tagline: "Full-Stack Matrimonial Platform & Real-Time Communication",
      ...
      metric: "Real-Time Voice/Video & Scalable APIs",
      achievements: [
         ...
         "Improved backend maintainability and scalability through modular architecture and clean coding practices",
      ],
   ...
   },
   {
      ...
      type: "Full-Time",
      status: "completed",
      tagline: "Recruitment & Workforce Management Engine",
      ...
      metric: "Scalable REST APIs & RBAC Systems",
      achievements: [
         "Built authentication systems, role-based access control (RBAC), candidate management workflows, and employer dashboards",
         "Designed scalable REST APIs and optimized database operations for recruitment and talent workflows",
   ...
   {
      id: "expertx-coding-academy",
      company: "ExpertX Coding Academy",
      role: "Technical Mentor",
      duration: "2025 – 2026",
      type: "Part-Time",
      status: "completed",
      tagline: "Engineering Mentorship & Software Architecture",
      ...
      metric: "25+ Developers Mentored",
      achievements: [
         "Mentored 25+ students in MERN Stack development, JavaScript, debugging, software architecture, and project development",
         "Conducted daily technical sessions covering agentic coding, project presentations, backend development, and modern engineering practices",
         "Guided students in architecting and building portfolio-ready, production-grade full-stack applications",
         "Conducted code reviews and architectural evaluations following Clean Architecture principles",
      ],
            ...
            <div className="max-w-5xl mx-auto">
               ...
               <div className="space-y-6 sm:space-y-8">
                  {experiences.map((exp, index) => {
                     ...
                     return (
                        <div key={exp.id} id={`exp-${exp.id}`} className="scroll-mt-28 relative flex items-start md:gap-8 group">
                           ...
                           {/* Experience TiltCard (Instant 3D interactive tilt without conflicting CSS transitions) */}
                           <div className="flex-1 w-full min-w-0">
                              <TiltCard
                                 max={6}
                                 glare={true}
                                 className="group/card relative p-5 sm:p-7 md:p-8 bg-white/95 dark:bg-[#181513]/95 backdrop-blur-xl border border-[#E2DDD2] dark:border-[#E5DFD3]/15 shadow-[0_10px_35px_-10px_rgba(24,21,19,0.06)] hover:shadow-[0_20px_45px_-10px_rgba(138,90,43,0.12)] hover:border-[#8A5A2B]/40 dark:hover:border-[#D4A373]/30 transition-[border-color,box-shadow] duration-300 rounded-3xl sm:rounded-[2rem]"
                              >
                     ...
                     <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-8">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto shrink-0">
                           <button
                              ...
                              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-2xl bg-[#181513] dark:bg-[#E5DFD3] hover:bg-[#8A5A2B] dark:hover:bg-[#D4A373] text-[#F7F5F0] dark:text-[#0B0A09] font-semibold text-sm shadow-md transition-all duration-300 cursor-pointer group"
                           >
