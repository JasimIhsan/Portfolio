...
export const experiences: ExperienceItem[] = [
   {
      ...
      description:
         "Spearheaded end-to-end mobile engineering for a cross-platform matrimony platform with strict privacy controls, real-time matching, and intuitive onboarding.",
      achievements: [
         "Designed high-performance Flutter component architecture with custom transition curves and gestures",
         "Architected secure authentication workflows, media verification queues, and privacy-first profile audits",
         "Integrated Firebase Cloud Messaging (FCM) push notifications with zero-latency delivery",
      ],
   ...
   },
   {
      ...
      description:
         "Built specialized recruitment portal for maritime personnel with dynamic talent search algorithms, automated CV parsing pipelines, and real-time candidate status.",
      achievements: [
         "Constructed relational data schemas with PostgreSQL & Prisma, optimizing complex query response by 45%",
         "Developed Next.js server actions and API route handlers for instantaneous applicant filtering",
         "Implemented administrative governance dashboards with role-based permission scopes",
      ],
   ...
   },
   {
      ...
      description:
         "Completed rigorous software engineering residency solving deep technical problems in distributed queues, microservice architectures, and scalable web apps.",
      achievements: [
         "Engineered BrewCode: A distributed JavaScript execution sandbox using Docker and BullMQ/Redis",
         "Built MentorsHub: Complete 1-on-1 mentorship platform with Socket.io chat and live video streaming",
         "Created ByteVerse: Production e-commerce store with RazorPay payment gateway integration",
      ],
   ...
   },
   {
      ...
      description:
         "Delivering tailored web systems, performance optimization, and architectural consulting for early-stage products and open-source tooling.",
      achievements: [
         "Authored reusable animation and UI utility libraries for modern web development",
         "Audited and optimized database queries, reducing latency on resource-constrained hosting environments",
         "Provided technical consultation on cross-platform mobile deployment strategies",
      ],
         ...
         {isDesktop ? (
            <div className="sticky top-0 h-screen w-full flex items-center justify-center px-6 overflow-hidden">
               ...
               <div className="max-w-6xl mx-auto w-full">
                  ...
                  <div className="text-center mb-8 md:mb-10">
                     ...
                     <h2 className="text-3xl md:text-5xl font-extrabold text-[#181513] dark:text-[#E5DFD3] tracking-tight mb-2">
                        Work Experience & Milestones
                     </h2>
                     <p className="text-sm md:text-base text-[#6E655C] dark:text-[#A89F91] max-w-2xl mx-auto font-normal">
                        Scroll or click any milestone to navigate through my career journey.
                     </p>
                  </div>
                  ...
                  <div className="grid lg:grid-cols-12 gap-8 items-center">
                     ...
                     <div className="lg:col-span-4 space-y-4">
                        <div className="p-6 rounded-3xl bg-white dark:bg-[#181513]/95 border border-[#E2DDD2] dark:border-[#E5DFD3]/15 shadow-sm">
                           <div className="flex items-center justify-between mb-4 pb-3 border-b border-[#EFECE4] dark:border-[#E5DFD3]/10">
                              <span className="text-xs font-bold uppercase tracking-widest text-[#6E655C] dark:text-[#A89F91]">
                                 Milestone Tracker
                              </span>
                                 ...
                                 return (
                                    <button
                                       ...
                                       className={`w-full text-left p-3.5 rounded-2xl transition-all duration-300 flex items-center justify-between cursor-pointer group ${
                                          isActive
                                             ? "bg-[#181513] dark:bg-[#231E1A] text-white shadow-md shadow-black/10 border border-[#181513] dark:border-[#D4A373]/30"
                                             : "hover:bg-[#EFECE4]/60 dark:hover:bg-[#231E1A]/60 text-[#6E655C] dark:text-[#A89F91] hover:text-[#181513] dark:hover:text-[#E5DFD3]"
                                       }`}
                                    >
                                       <div className="flex items-center gap-3">
                                          <div
                                             className={`w-2.5 h-2.5 rounded-full transition-transform ${
                                                isActive
                                                   ? "bg-[#D4A373] scale-125 ring-4 ring-[#D4A373]/20"
                                                   : "bg-[#DCD6C8] dark:bg-[#3D2D20] group-hover:bg-[#8A5A2B] dark:group-hover:bg-[#D4A373]"
                                             }`}
                                          />
                                          <div>
                                             <div
                                                className={`font-semibold text-sm leading-snug ${
                                                   isActive
                                                      ? "text-white dark:text-[#E5DFD3]"
                                                      : "text-[#181513] dark:text-[#E5DFD3]"
                                                }`}
                                             >
                                                {exp.role}
                                             </div>
                                             <div
                                                className={`text-xs ${
                                                   isActive ? "text-[#A89F91]" : "text-[#6E655C] dark:text-[#A89F91]"
                                                }`}
                                             >
                                                {exp.company}
                                             </div>
                                       ...
                                       <ChevronRight
                                          ...
                                          className={`transition-transform duration-300 ${
                                             isActive
                                                ...
                                                : "text-[#DCD6C8] dark:text-[#3D2D20] opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5"
                                          }`}
                                       />
                                    </button>
                                 );
                     ...
                     <div className="lg:col-span-8 relative min-h-[440px] flex items-center">
                        <AnimatePresence mode="wait" custom={direction}>
                           <motion.div
                              key={currentExp.id}
                              custom={direction}
                              initial={{ opacity: 0, y: direction * 20, scale: 0.98 }}
                              animate={{ opacity: 1, y: 0, scale: 1 }}
                              exit={{ opacity: 0, y: direction * -20, scale: 0.98 }}
                           ...
                           >
                              <TiltCard
                                 max={6}
                                 glare={true}
                                 className="p-8 md:p-10 bg-white dark:bg-[#181513]/95 border border-[#E2DDD2] dark:border-[#E5DFD3]/15 shadow-[0_15px_40px_-15px_rgba(24,21,19,0.06)] hover:shadow-[0_25px_50px_-12px_rgba(138,90,43,0.12)] transition-shadow duration-500 rounded-[2rem]"
                              >
                                 {/* Card Top Pill Bar */}
                                 <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
                                    ...
                                    <div className="flex items-center gap-3">
                                       <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#EFECE4] dark:bg-[#231E1A] text-[#8A5A2B] dark:text-[#D4A373] border border-[#DCD6C8] dark:border-[#E5DFD3]/15">
                                          {currentExp.type}
                                       </span>
                                 ...
                                 {/* Role Headline */}
                                 <h3 className="text-2xl md:text-3xl font-bold text-[#181513] dark:text-[#E5DFD3] mb-2">
                                    {currentExp.role}
                                 </h3>
                                 <p className="text-sm font-medium text-[#8A5A2B] dark:text-[#D4A373] mb-6">
                                    {currentExp.tagline}
                                 </p>

                                 {/* Narrative Description */}
                                 <p className="text-base md:text-lg text-[#6E655C] dark:text-[#A89F91] leading-relaxed mb-6 font-normal">
                                 ...
                                 <div className="p-5 rounded-2xl bg-[#EFECE4] dark:bg-[#231E1A] border border-[#E2DDD2] dark:border-[#E5DFD3]/10 mb-8 space-y-2.5">
                                    ...
                                    {currentExp.achievements.map((item, i) => (
                                       <div
                                          key={i}
                                          className="flex items-start gap-2.5 text-sm text-[#4A433D] dark:text-[#D5CEC2]"
                                       >
                                          <CheckCircle2
                                             size={16}
                                             className="text-[#8A5A2B] dark:text-[#D4A373] shrink-0 mt-0.5"
                                          />
                                          <span>{item}</span>
                                       </div>
                                    ))}
                                 ...
                                 {/* Tech Stack Chips */}
                                 <div className="space-y-2">
                                    <div className="text-xs font-semibold uppercase tracking-wider text-[#A89F91] dark:text-[#6E655C]">
            ...
            <div className="py-24 px-5 max-w-2xl mx-auto">
               ...
               <div className="text-center mb-10">
                  ...
                  <h2 className="text-3xl font-extrabold text-[#181513] dark:text-[#E5DFD3] tracking-tight mb-2">
                     Work Experience
                  </h2>
                  <p className="text-sm text-[#6E655C] dark:text-[#A89F91] font-normal">
                     A chronological record of production roles, full-stack systems, and client delivery.
                  </p>
               </div>
               ...
               <div className="space-y-6">
                  {experiences.map((exp) => (
                     <div
                        key={exp.id}
                        className="p-6 bg-white dark:bg-[#181513]/95 border border-[#E2DDD2] dark:border-[#E5DFD3]/15 shadow-sm rounded-3xl relative overflow-hidden"
                     >
                        {/* Top Badges */}
                        <div className="flex flex-wrap items-center justify-between gap-2 mb-3">
                           ...
                           <div className="flex items-center gap-2 text-xs">
                              <span className="px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-[#EFECE4] dark:bg-[#231E1A] text-[#8A5A2B] dark:text-[#D4A373] border border-[#DCD6C8] dark:border-[#E5DFD3]/15">
                                 {exp.type}
                              </span>
                        ...
                        <p className="text-sm text-[#6E655C] dark:text-[#A89F91] leading-relaxed mb-4 font-normal">
                           {exp.description}
                        </p>
                        ...
                        <div className="p-4 rounded-2xl bg-[#EFECE4]/70 dark:bg-[#231E1A] border border-[#E2DDD2] dark:border-[#E5DFD3]/10 mb-4 space-y-2">
                           ...
                           {exp.achievements.map((item, i) => (
                              <div
                                 key={i}
                                 className="flex items-start gap-2 text-xs text-[#4A433D] dark:text-[#D5CEC2]"
                              >
                                 <CheckCircle2
                                    size={14}
                                    className="text-[#8A5A2B] dark:text-[#D4A373] shrink-0 mt-0.5"
                        ...
                        <div className="flex flex-wrap gap-1.5">
                           {exp.skills.map((skill) => (
                              <span
                                 key={skill}
                                 className="px-2.5 py-1 text-[11px] font-medium text-[#4A433D] dark:text-[#D5CEC2] bg-[#EFECE4] dark:bg-[#231E1A] border border-[#DCD6C8] dark:border-[#E5DFD3]/15 rounded-lg"
                              >
                                 {skill}
                              </span>
                           ))}
